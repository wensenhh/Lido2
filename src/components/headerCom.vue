  ...
  <div class="flex-row justify-between items-center section_2">
    <div class="flex-row space-x-8">
      <img class="shrink-0 image"
        src="https://codefun-proj-user-res-1256085488.cos.ap-guangzhou.myqcloud.com/641bf7ba5a7e3f031045ebb8/645348c1b98f5d001166de68/16831798113834414126.png" />
      <div class="group">
        <span class="text">
          Lido
          <br />
    ...
    <div class="flex-row">
      ...
      <img class="image_2" @click="langshow = true"
        src="https://codefun-proj-user-res-1256085488.cos.ap-guangzhou.myqcloud.com/641bf7ba5a7e3f031045ebb8/645348c1b98f5d001166de68/16831798113850130050.png" />
      <img class="image_2" @click="tabbarshow = true"
        src="https://codefun-proj-user-res-1256085488.cos.ap-guangzhou.myqcloud.com/641bf7ba5a7e3f031045ebb8/645348c1b98f5d001166de68/16831798113865672961.png" />
    </div>
  </div>
...
.section_2 {
  padding: 12px 16px;
  background-image: linear-gradient(171.2deg, #f9f9f9 0%, #f8f8f8 100%);
  position: fixed;
  top: 0;
  left: 0;
  right: 0;
